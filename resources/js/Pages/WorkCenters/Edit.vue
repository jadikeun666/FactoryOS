<template>
  <div class="form-page">
    <header class="page-header">
      ...
      <h1 class="page-title">Edit Work Center</h1>
    </header>
    ...
    <form class="wc-form" @submit.prevent="submit">
      ...
      <label class="field">
        ...
        <input v-model="form.code" type="text" class="input" required maxlength="20" />
...
const form = useForm({
  ...
  capacity_per_shift_minutes: Number(props.workCenter.capacity_per_shift_minutes),
  setup_time_minutes: Number(props.workCenter.setup_time_minutes),
  is_active: props.workCenter.is_active,
  description: props.workCenter.description,
})

function submit() {
  form.put(`/work-centers/${props.workCenter.id}`)
}
</script>
