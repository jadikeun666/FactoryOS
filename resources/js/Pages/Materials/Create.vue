<template>
  <div class="form-page">
    <header class="page-header">
      ...
      <h1 class="page-title">Tambah Material</h1>
    </header>
    ...
    <form class="wc-form" @submit.prevent="submit">
      ...
      <label class="field">
        <span>SKU</span>
        <input v-model="form.sku" type="text" class="input" required maxlength="50" placeholder="mis. MTR-001" />
      ...
      <div class="field-row">
        <label class="field">
          <span>Unit</span>
          <input v-model="form.unit" type="text" class="input" maxlength="20" placeholder="pcs / meter / lembar" />
